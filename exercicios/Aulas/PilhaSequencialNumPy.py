...
class Pilha:
    ...
    def elemento(self, posicao:int)->any:
        ...
        try:
            ...
            raise PilhaException(f'A posicao deve ser um número maior que zero e menor do que {self.__topo+1}')
        except:
            raise
    ...
    def busca(self, valor:any)->int:
        """ Método que recupera a posicao ordenada, dentro da pilha, em que se
            ...
            ocorrência do valor, apenas a primeira ocorrência será retornada
        ...
        for i in range(self.__topo+1):
            if (self.__dado[i] == valor):
                return i+1
        raise PilhaException(f'Chave {valor} nao esta na lista')
